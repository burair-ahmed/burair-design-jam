...
interface ClientOnlyConfig extends CommonConfig {
   ...
   * check out directly or will create a checkout session via your server/serverless function.
   */
  ...
  /**
   * Payment mode: whether it's a one-time payment or a subscription
   */
...
export interface CartState {
  ...
  /**
   * The mode used for determining if you will be checking out
   * in the client's browser only or creating a checkout session
  ...
  language: string
  /**
   * Payment or Subscription mode, depending on what is selected
   */
  mode: 'payment' | 'subscription'
}
...
export interface CartActions {
  ...
  /**
   * Redirects customers to checkout. Works in both CheckoutSession and ClientOnly mode.
  ...
  /**
   * Redirects customers to checkout with a single product.
